...
let RoutingapiserviceService = class RoutingapiserviceService {
    constructor(httpclient) {
        ...
        this.API_KEY = 'AmYv6an9J6eMbSxaNcoOuf8RUHZP4ULqStT84uaGjTBSnPqOE3PBWGdmxCG55SPf';
        this.responses = [];
        this.stations = [
...
RoutingapiserviceService = tslib_1.__decorate([
    Injectable({
        providedIn: 'root'
    })
], RoutingapiserviceService);
export { RoutingapiserviceService };
//# sourceMappingURL=routingapiservice.service.js.map